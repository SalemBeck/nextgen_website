...
})(window,document,'script','dataLayer','GTM-KTLX7DTM');</script>
<!-- End Google Tag Manager -->
    <!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-FE5LRLL2MK"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-FE5LRLL2MK');
</script>
    <meta charset="UTF-8">
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-KTLX7DTM"
